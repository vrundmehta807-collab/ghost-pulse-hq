...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Ghost Hunter HQ — Paranormal Investigation Dashboard" },
      { property: "og:description", content: "Cyberpunk paranormal investigation HQ tracking ghosts, haunted locations, and threat levels in real time." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Ghost Hunter HQ — Paranormal Investigation Dashboard" },
      { name: "twitter:description", content: "Cyberpunk paranormal investigation HQ tracking ghosts, haunted locations, and threat levels in real time." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/25b7a555-69b9-43a3-8c15-08851e8c695b/id-preview-f7a1273c--2c40c6f4-5b30-4c9e-bf41-e6baa71c56bb.lovable.app-1781666741357.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/25b7a555-69b9-43a3-8c15-08851e8c695b/id-preview-f7a1273c--2c40c6f4-5b30-4c9e-bf41-e6baa71c56bb.lovable.app-1781666741357.png" },
    ],
    links: [
